                ...
                <div class="container">
                    ...
                    <div class="container card  p-4">
                        ...
                        <ol class="breadcrumb col-lg-12">
                            ...
                            <li>
                                <a href="/dosen/riwayat" class="breadcrumb-item active fw-bold text-success px-1">Riwayat (<span> {{ $jumlah_riwayat }} </span>) </a>
                            </li>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center d-flex justify-content-around">
                                            <div>
                                                <a href='/dosen/skripsi/{{ $skripsi->id }}'type="button" class="badge bg-info rounded border-0"><i class="fa fa-circle-info"></i></a>
                                            </div>
                                        </td>
                                    </tr>
                                    @endforeach
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center d-flex justify-content-around">
                                            <div>
                                                <a href='/dosen/{{ $proposal->id }}'type="button" class="badge bg-info rounded border-0"><i class="fa fa-circle-info"></i></a>
                                            </div>
                                        </td>
                                    </tr>
                                    @endforeach
