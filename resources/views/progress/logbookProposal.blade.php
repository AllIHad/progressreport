    ...
    <div class="container">
        ...
        <table style="border: 1px solid black; border-collapse: collapse; width: 100%; margin-bottom: 20px;">
            ...
            <tbody style="border: 1px solid black;">
                <tr>
                    <td style=" vertical-align: top; padding: 10px; border: 1px solid black; height: 400px;">{{ $proposal->diskusi }}</td>
                    <td style=" vertical-align: top; padding: 10px; border: 1px solid black; height: 400px;">{{ $proposal->komentar }}</td>
                </tr>
            </tbody>
        </table>
        ...
        <table style="border: 1px solid black; border-collapse: collapse; width: 100%;">
            ...
            <tbody style="border: 1px solid black;">
                <tr>
                    <td style="text-align: center; padding: 10px; border: 1px solid black; height: auto;"> {{ $proposal->keterangan }}</td>
                </tr>
            </tbody>
            <tbody style="border: 1px solid black;">
                <tr>
                    <td style="text-align: center; padding: 10px; border: 1px solid black; height: auto;"> Pembimbing,
                        ...
                        <br>
                        <br>
                        ( {{$proposal->pembimbing_nama}} ) <br>
                        NIP. {{$proposal->pembimbing_nip}}
                    </td>
                </tr>
            </tbody>
        </table>
