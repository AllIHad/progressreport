...
class CreatePrSkripsisTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('pr__skripsis', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('status')->default('LogBook SKRIPSI');
            $table->json('bab1')->nullable();
            $table->json('bab2')->nullable();
            $table->json('bab3')->nullable();
            $table->json('bab4')->nullable();
            $table->json('bab5')->nullable();
    ...
    {
        Schema::dropIfExists('pr__skripsis');
    }
}
